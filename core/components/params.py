...
def get_args():
    ...
    parser.add_argument(
        "--prefix",
        help="experiment prefix, if given creates subfolder in experiment directory",
    )
    parser.add_argument(
        "--new_dir",
        default=False,
    ...
    parser.add_argument(
        ...
        default="train",
        type=str,
        choices=["train", "val", "instance", "val_sweep"],
        help="mode of the program (training, validation, Sweeping validation, or instance)",
    )
    parser.add_argument(
        "--test_prediction",
        default=True,
    ...
    parser.add_argument(
        ...
        default=False,
        type=int,
        help="if True, shuffle data during validation",
    )
