...
from core.utils.general_utils import AttrDict, get_dim_inds
...
class BCELogitsLoss(Loss):
    def compute(self, estimates, targets, pos_weight=None):
        return BCEWithLogitsLoss(pos_weight=pos_weight)(estimates, targets)
